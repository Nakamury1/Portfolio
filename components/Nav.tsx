...
export default function Nav() {
    ...
    return(
        ...
        <button 
            className="block md:hidden p-8 focus:outline-none"
            onClick={() => setIsOpen(!isOpen)}
        >
            {isOpen ? (
                <Image src="/font_awesome/close.svg" alt="Fermer" width={30} height={30} />
            ) : (
        ...
        <div className={clsx(
            "flex-row text-xl md:flex md:flex-row md:items-center md:space-x-8 absolute md:static top-24 left-0 w-full md:w-auto bg-purple-100 md:bg-transparent shadow-md md:shadow-none transition-all",
            ...
            <div className="flex md:hidden justify-center space-x-4 mt-4 mb-4">
